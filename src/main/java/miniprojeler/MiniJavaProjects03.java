...
public class MiniJavaProjects03 {
    ...
    Project: Bir siteye üye olma ve giriş yapma sayfası tasarlayınız.
             ...
             giriş (login) : kullanıcı adı/email ve şifre girilir.
                             kullanıcı adı veya email bulunmazsa kayıtlı değil, üye olun uyarısı verilir.
             ...
             email validation: boşluk içermemeli
                             ...
                             : gmail.com, hotmail.com veya yahoo.com ile bitmeli.
                              mailin kullanıcı adı kısmında(@ den önce) sadece büyük-küçük harf, rakam ya da -,_ sembolleri olabilir.
