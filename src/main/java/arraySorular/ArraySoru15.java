...
public class ArraySoru15 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("listIsim = " + listIsim);//güncelleme öncesiz->

        listIsim.set(2, str8);//3. elelman 2. index str8 ile güncellendi
        listIsim.set(7, str3);//8. elelman 7. index str2 ile güncellendi

        System.out.println("listIsim = " + listIsim);//güncelleme sonrası ->
