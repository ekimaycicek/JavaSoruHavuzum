...
public class Lenght {
    ...
    public static void main(String[] args) {
       ...
       /*
        ...
        String str="madem geldin dünyaya otur calıs javaya";
        int strkrktr = str.length();//int type bir data verir.
        System.out.println(str);
        System.out.println(strkrktr);//38
        ...
        String name;// deklare edilmiş ama atanmamış  string String method çalışmaz CTE vcerir.
